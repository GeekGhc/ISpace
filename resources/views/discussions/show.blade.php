        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <button class="btn btn-default my-favorite"><i class="fa  fa-star-o"
                    ...
                    <div class="comment-note">
                        <div class="comment-content">
                            ...
                            <div class="comment-footer">
                                ...
                                <a style="margin-right: 5px">分享</a><i>|</i><a class="aaa" data-content="JellyTest"  style="margin-left: 5px" @click="onreply">回复</a>
                                    </span>
                            </div>
                            ...
                            <div class="reply-form-container" v-if="reply_form">
