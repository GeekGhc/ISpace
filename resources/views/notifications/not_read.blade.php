            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="notify-main notify-section-content">
                    <div class="ui pointing secondary menu">
                        ...
                        <a class="item" data-tab="third" href="/user/notifications/message"><i
                                    class="fa fa-commenting"></i>私信消息</a>
                        <a href="/user/notifications/read" style="float: right;padding-top: 5px">
                            <button class="ui teal button">全部标记为已读</button>
                        </a>
                    </div>
